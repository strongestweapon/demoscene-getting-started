...
<br><br>
commodore 64, amiga 등의 게임이 시작될때 나오는 intro에 자기의 이름을 새겨 넣거나 절대 불가능할것은 그래픽을 넣는 식으로 과시하다 게임 플레이보다 이렇게 다시만들어진 intro만 보는 사람들이 늘어 나게됨. 이거이 데모씬의 시작이라고 보는 사람들이 많다.  
...
## 데모씬 도구(Tool)
- 그래픽
  - [Grafx2](https://www.pouet.net/prod.php?which=51865)
  - [Multipaint](https://www.pouet.net/prod.php?which=66976)
- 오디오
  - [4klang](http://4klang.untergrund.net/)
  - [Clinkster](https://www.pouet.net/prod.php?which=61592)
- 코딩
  - [Sizecoding](http://www.sizecoding.org/wiki/Main_Page): 사이즈 제한 코딩
  - [in4k](https://in4k.github.io/): 사이즈 제한 코딩 
  - [shadertoy](https://www.shadertoy.com/): GLSL 셰이더 

### 일반 Tool 모음
  - [pouet demotool list](https://www.pouet.net/prodlist.php?type%5B%5D=demotool): 대부분의 데모 툴을 받을 수 있는 모음 사이트  
  - [demoscene starter kit](https://github.com/anttihirvonen/demoscene-starter-kits): PC 1k 데모 시작 가능한 템플릿 파일 및 설명
  - [demo tool gallery](https://peisik.untergrund.net/engines/): 각종 데모툴 스크린 캡쳐를 통해 머하는 툴인지 짐작 가능

## 데모씬 커뮤니티
- [Pouët.net](https://www.pouet.net/)
- [Demozoo](https://demozoo.org/)
- [Wanted!](https://wanted.scene.org/)
## 사이트 가입하기
